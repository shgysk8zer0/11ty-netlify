...
### Changed
- Update `@shgysk8zer0/rollup-import` with support for Import Attributes

## [v1.1.28] - 2025-12-04

### Changed
- Multiple dependncy updates
...
### Fixed
- Update `@shgysk8zer0/importmap` with fixes for exports / ignore
